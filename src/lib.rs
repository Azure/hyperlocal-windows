//! hyperlocal-windows provides [hyper](http://github.com/hyperium/hyper) client and server bindings
//! for [unix domain sockets](https://github.com/Azure/tokio-uds-windows)
//!
//! See the `hyperlocal_windows::UnixConnector` docs for how to configure hyper clients and the `hyperlocal_windows::server::Http` docs
...
///
/// let url: hyper::Uri = hyperlocal_windows::Uri::new(
